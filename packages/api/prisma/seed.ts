...
const PRESIDENTS: SeedCandidate[] = [
  ...
  },
  {
    ...
    state: 'RJ',
    position: Position.PRESIDENTE,
    photoUrl: '/images/candidates/flavio-bolsonaro.jpg',
  ...
  },
  {
    ...
    state: 'GO',
    position: Position.PRESIDENTE,
    photoUrl: '/images/candidates/ronaldo-caiado.jpg',
  ...
  },
  {
    ...
    state: 'RS',
    position: Position.PRESIDENTE,
    photoUrl: '/images/candidates/eduardo-leite.jpg',
  ...
  },
  {
    ...
    state: 'MS',
    position: Position.PRESIDENTE,
    photoUrl: '/images/candidates/simone-tebet.jpg',
  ...
  },
  {
    ...
    state: 'SP',
    position: Position.PRESIDENTE,
    photoUrl: '/images/candidates/renan-santos.jpg',
  ...
  },
  {
    ...
    state: 'SP',
    position: Position.PRESIDENTE,
    photoUrl: '/images/candidates/aldo-rebelo.jpg',
...
const GOVERNORS: SeedCandidate[] = [
  // São Paulo
  {
    ...
    photoUrl: '/images/candidates/tarcisio-de-freitas.jpg',
  ...
  // Rio de Janeiro
  {
    ...
    state: 'RJ',
    position: Position.GOVERNADOR,
    photoUrl: '/images/candidates/claudio-castro.jpg',
  ...
  // Bahia
  {
    ...
    state: 'BA',
    position: Position.GOVERNADOR,
    photoUrl: '/images/candidates/jeronimo-rodrigues.jpg',
  ...
  // Paraná
  {
    ...
    state: 'PR',
    position: Position.GOVERNADOR,
    photoUrl: '/images/candidates/ratinho-junior.jpg',
  ...
  for (const c of all) {
    ...
    if (existing) {
      await prisma.candidate.update({
        ...
        data: {
          slug,
          // Local paths (/images/) always win — they replaced broken Wikimedia URLs.
          // For external URLs, DB takes priority over seed defaults.
          photoUrl: c.photoUrl?.startsWith('/images/')
            ? c.photoUrl
            : existing.photoUrl ?? c.photoUrl ?? null,
